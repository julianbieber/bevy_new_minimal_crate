# Bevy New Minimal Crate

A minimal template for use when generating new Bevy projects.
Basically a fork of [Bevy New Minimal](https://github.com/TheBevyFlock/bevy_new_minimal), but I already had a fork of that repo on my account.
